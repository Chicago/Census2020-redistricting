...
leaflet() %>%
    addTiles(urlTemplate = leaflet_stadia_url, 
             attribution = leaflet_stadia_attribution) %>% 
    addPolygons(data=shp_tracts_2020_10[shp_tracts_2020_10$community %in% samp_ca_names, ],
                color="blue", fill = FALSE) %>%
    addLabelOnlyMarkers(data = shp_tracts_2020_10[shp_tracts_2020_10$community %in% samp_ca_names, ],
                        ...
                        labelOptions = labelOptions(noHide = TRUE,
                                                    ...
                                                    style = list("color" = "white",
                                                                 "font-style" = "bold")))%>%
    addPolygons(data=shp_tracts_2020_20[shp_tracts_2020_20$community %in% samp_ca_names, ],
                color="red", fill = FALSE) %>%
    addLabelOnlyMarkers(data = shp_tracts_2020_20[shp_tracts_2020_20$community %in% samp_ca_names, ],
